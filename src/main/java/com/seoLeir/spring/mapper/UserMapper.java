...
public abstract class UserMapper {
    ...
    public abstract User userFromUserCreateEdit(UserCreateEditDto userCreateEditDto, Company company);
    ...
    public abstract void updateUserFromUserCreateEditDto(UserCreateEditDto userCreateEditDto, @MappingTarget User user, Company company);
